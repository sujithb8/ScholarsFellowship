                        ...
                        >
                            {
                                userInfo && userInfo.role === 1 ?
                                    <>
                                        ...
                                        <MenuItem component={<Link to="/admin/universities" />} icon={<WorkIcon />}> Universities </MenuItem>
                                        <MenuItem component={<Link to="/admin/profile" />} icon={<WorkIcon />}>Personal Info </MenuItem>
                                    </> :
                                    <>
                                        <MenuItem component={<Link to="/user/dashboard" />} icon={<DashboardIcon />}> Dashboard </MenuItem>
                                        <MenuItem component={<Link to="/user/shortlisted" />} icon={<WorkHistoryIcon />}> Applied Jobs </MenuItem>
                                        <MenuItem component={<Link to="/user/profile" />} icon={<Person3Icon />}> Personal Info </MenuItem>
                                    </>
                            }
