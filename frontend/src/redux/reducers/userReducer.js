import {
    ...
    USER_APPLY_UNIV_FAIL,
    USER_APPLY_UNIV_REQUEST,
    USER_APPLY_UNIV_RESET,
    USER_APPLY_UNIV_SUCCESS,
    USER_LOAD_FAIL,
    USER_LOAD_REQUEST,
    USER_LOAD_RESET,
    USER_LOAD_SUCCESS,
...
// apply for a univ reducer
export const userApplyUnivReducer = (state = {}, action) => {
    switch (action.type) {
        case USER_APPLY_UNIV_REQUEST:
            return { loading: true }
        case USER_APPLY_UNIV_SUCCESS:
            return {
                loading: false,
                userUniv: action.payload,
            }
        case USER_APPLY_UNIV_FAIL:
            return { loading: false, error: action.payload }
        case USER_APPLY_UNIV_RESET:
            return {}
        default:
            return state;
    }
