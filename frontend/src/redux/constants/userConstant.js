...
export const USER_APPLY_UNIV_REQUEST = "USER_APPLY_UNIV_REQUEST";
export const USER_APPLY_UNIV_SUCCESS = "USER_APPLY_UNIV_SUCCESS";
export const USER_APPLY_UNIV_FAIL = "USER_APPLY_UNIV_FAIL";
export const USER_APPLY_UNIV_RESET = "USER_APPLY_UNIV_RESET";
